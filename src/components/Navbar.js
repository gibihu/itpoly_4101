...
function Navbar({ setActiveSection }) {
  return (
    <nav style={styles.nav}>
      <button onClick={() => setActiveSection("home")} style={styles.button}>
        Home
      </button>
      <button onClick={() => setActiveSection("about")} style={styles.button}>
        About Us
      </button>
      <button onClick={() => setActiveSection("courses")} style={styles.button}>
        Courses
      </button>
      <button onClick={() => setActiveSection("contact")} style={styles.button}>
        Contact Us
      </button>
    </nav>
  );
